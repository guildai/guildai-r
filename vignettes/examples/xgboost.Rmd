...
- There is no ‘guildai’ specific configuration anywhere in the script
  code. It’s a regular R script, that you can safely `source()` or work
  with interactively at the REPL.
- We declare two custom `output-scalars` patterns in the scripts comment
  frontmatter. This informs guild how to parse the default xgboost
  stdout output and extract scalar values from it.
...
##    <chr>                            <chr> <chr>          <dbl> <dbl>
##  1 e85e1ba939634e32979d8c3567ab80cf <NA>  test-error    0.0428     1
##  2 e85e1ba939634e32979d8c3567ab80cf <NA>  test-logloss  0.543      1
##  3 e85e1ba939634e32979d8c3567ab80cf <NA>  train-error   0.0465     1
##  4 e85e1ba939634e32979d8c3567ab80cf <NA>  train-logloss 0.545      1
##  5 e85e1ba939634e32979d8c3567ab80cf <NA>  test-error    0.0403     2
##  6 e85e1ba939634e32979d8c3567ab80cf <NA>  test-logloss  0.440      2
##  7 e85e1ba939634e32979d8c3567ab80cf <NA>  train-error   0.0416     2
##  8 e85e1ba939634e32979d8c3567ab80cf <NA>  train-logloss 0.442      2
##  9 e85e1ba939634e32979d8c3567ab80cf <NA>  test-error    0.0248     3
## 10 e85e1ba939634e32979d8c3567ab80cf <NA>  test-logloss  0.368      3
## # … with 70 more rows
```
...
![](xgboost_files/figure-commonmark/unnamed-chunk-6-1.png)
